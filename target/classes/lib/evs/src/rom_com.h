...
extern const short CB_lsf[];
extern const short CB_p_lsf[];
...
extern const int   C_VQ[LATTICE_DIM+1][LATTICE_DIM+1];
...
extern const short perm_MSLVQ[][4];
...
extern const short FixBranch_tbl[4][4][N_STAGE_VQ - 4];
...
/* Band structure */
extern const short band_len_HQ[];
extern const short band_start_HQ[];
extern const short band_end_HQ[];
...
extern const float thren_HQ[39];
...
/* HQ_NORMAL mode */
extern const short bits_lagIndices_modeNormal[NB_SWB_SUBBANDS];
