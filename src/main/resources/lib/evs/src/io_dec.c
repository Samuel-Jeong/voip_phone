...
)
{
    ...
    *noDelayCmp = 0;
    ...
    if( i < argc - 1 )
    {
        ...
        /*if ( (*f_stream = fmemopen(src_data, src_data_len, "rb")) == NULL )
        {
    ...
    if( i < argc )
    {
        ...
        //if ( (*f_synth = open_memstream( &dst_data, dst_data_len )) == NULL )
        //if ( (*f_synth = fmemopen(dst_data, *dst_data_len, "wb")) == NULL )
        //{
